...
using New.Exam.Entities;

namespace New.Exam.Controllers
{
    public class ExamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StartTime,Date,Duration")] Exam exam)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StartTime,Date,Duration")] Exam exam)
        {
            if (id != exam.Id)
            {
                return NotFound();
