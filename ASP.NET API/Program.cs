...
ASP.NET_API.Entities.AspNetApiContext.connectionString = builder.Configuration.GetConnectionString("T2203E_demo");
...
// add Handlers
builder.Services.AddSingleton<IAuthorizationHandler, ASP.NET_API.Handlers.ValidBirthdayHandler>();
...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("ValidYearOld", policy => policy.AddRequirements(
        new ASP.NET_API.Requirements.YearOldRequirement(Convert.ToInt32(builder.Configuration["ValidYearOld:Min"]),
